    ...
    <div class="peoduct-table-wrap">
        ...
        <tbody>
            <tr>
                ...
                <td class="product-table__bold">#F287</td>
                <td class="product-table__bold">$375.00</td>
                <td>
                    <label class="product-table__container">
                        <input type="checkbox" checked="checked">
                        <span class="product-table__checkmark"></span>
                    </label>
                </td>
            </tr>
            <tr>
